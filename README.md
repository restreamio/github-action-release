...
1. Upload `LICENSE.txt` and any `dist/*` files as release assets.
...
- The `files` parameter supports multi-line [glob](https://github.com/isaacs/node-glob) patterns.
...
```yaml
- uses: "restreamio/github-action-release@<VERSION>"
```
